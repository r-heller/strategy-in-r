...
where $R_t^+(a) = \max(0, R_t(a))$. This algorithm is the building block of **counterfactual regret minimization** (CFR), covered in \@ref(sec-cfr-poker).
...
<img src="23-ml-foundations-for-gt_files/figure-epub3/regret-convergence-1.png" alt="Regret matching convergence in Rock-Paper-Scissors. Player 1's time-averaged strategy converges toward the Nash equilibrium of (1/3, 1/3, 1/3) for each action." width="80%" />
<p class="caption">(\#fig:regret-convergence)Regret matching convergence in Rock-Paper-Scissors. Player 1's time-averaged strategy converges toward the Nash equilibrium of (1/3, 1/3, 1/3) for each action.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="23-ml-foundations-for-gt_files/figure-epub3/decision-boundary-1.png" alt="Decision boundary for predicting cooperation. The logistic regression separates cooperators (orange) from defectors (blue) based on the opponent's historical cooperation rate and normalized round number." width="80%" />
<p class="caption">(\#fig:decision-boundary)Decision boundary for predicting cooperation. The logistic regression separates cooperators (orange) from defectors (blue) based on the opponent's historical cooperation rate and normalized round number.</p>
</div>
