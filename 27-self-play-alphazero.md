...
<img src="27-self-play-alphazero_files/figure-epub3/mcts-tree-1.png" alt="MCTS search from an empty Tic-Tac-Toe board (100 iterations). Each cell shows visit count and win rate from X's perspective. The center (position 5) receives the most visits, reflecting its strategic importance. Corner moves also receive high visit counts, consistent with known optimal opening play." width="80%" />
<p class="caption">(\#fig:mcts-tree)MCTS search from an empty Tic-Tac-Toe board (100 iterations). Each cell shows visit count and win rate from X's perspective. The center (position 5) receives the most visits, reflecting its strategic importance. Corner moves also receive high visit counts, consistent with known optimal opening play.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="27-self-play-alphazero_files/figure-epub3/self-play-winrate-1.png" alt="MCTS win rate against a random opponent as search budget increases. With only 10 iterations per move, MCTS wins about 68% of games. By 500 iterations it wins nearly every game, demonstrating how deeper search translates directly into stronger play." width="80%" />
<p class="caption">(\#fig:self-play-winrate)MCTS win rate against a random opponent as search budget increases. With only 10 iterations per move, MCTS wins about 68% of games. By 500 iterations it wins nearly every game, demonstrating how deeper search translates directly into stronger play.</p>
</div>
