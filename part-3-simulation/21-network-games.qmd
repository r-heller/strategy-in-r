...
author: "Raban Heller"
date-modified: today
abstract: "Strategic interaction on graph structures: adjacency-matrix representations, network generation, best-response dynamics, and cooperation on small-world networks — all implemented without igraph."
keywords: ["network games", "adjacency matrix", "small-world", "cooperation", "Watts-Strogatz"]
other-links:
  - text: Download Chapter PDF
    href: ../downloads/games-on-networks.pdf
    icon: file-pdf
---
...
#| fig-cap: "Three network topologies with 30 nodes. Left: ring lattice (k = 4) with high clustering but long paths. Centre: Watts-Strogatz small-world (k = 4, p = 0.2) with high clustering and short paths. Right: Erdős-Rényi random network (p = 0.13) with low clustering and short paths."
#| fig-width: 9
#| fig-height: 4
...
```{r}
#| label: fig-network-cooperation
#| fig-cap: "Cooperation rates over time in the PD across three topologies (50 nodes, 20 replications). The ring lattice sustains cooperation through protective clusters; the random network loses it fastest."
#| fig-width: 7
#| fig-height: 5
...
- **Spatial PD**: The lattice-based spatial PD (@sec-spatial-pd) is a special case where the adjacency matrix encodes a regular grid.
