...
```{r, q-heatmap, fig.cap="Learned state values (max Q per state) in the 5x5 gridworld. The agent starts at (1,1) and must reach the goal at (5,5). Dark cells are obstacles. Higher values (orange) indicate states closer to the goal along the optimal path.", fig.width=6, fig.height=5}
...
```{r, exploration, fig.cap="Cumulative regret comparison between epsilon-greedy and UCB on a 10-armed bandit. UCB explores proportionally to uncertainty, yielding lower regret.", fig.width=7, fig.height=5}
