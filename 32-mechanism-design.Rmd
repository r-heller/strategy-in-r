...
```{r, welfare-comparison, fig.cap="Social welfare under VCG and majority voting compared to the first-best optimum. VCG always achieves the efficient outcome; majority voting sometimes selects the wrong alternative.", fig.width=6, fig.height=5}
...
```{r, vcg-transfers, fig.cap="Clarke tax payments in the VCG mechanism for a representative sample of 20 instances. Agents who are pivotal --- those whose presence changes the chosen outcome --- pay a positive tax.", fig.width=7, fig.height=5}
