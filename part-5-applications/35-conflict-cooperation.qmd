---
title: "Conflict and Cooperation Models"
short-title: "Conflict & Cooperation"
author: "Raban Heller"
date-modified: today
abstract: "Applying game theory to international relations and social dilemmas — Chicken, Stag Hunt, Schelling focal points, and arms race dynamics."
keywords: ["Chicken game", "Stag Hunt", "Schelling focal points", "arms race", "cooperation", "conflict"]
other-links:
  - text: Download Chapter PDF
    href: ../downloads/conflict-and-cooperation-models.pdf
    icon: file-pdf
---
...
#| fig-cap: "Phase diagram of Stag Hunt replicator dynamics under three risk-dominance regimes. Each curve is one trajectory starting from a different initial proportion of Stag hunters. The dashed line marks the mixed-NE threshold separating the basins of attraction."
#| fig-width: 7
#| fig-height: 5
...
```{r}
#| label: fig-arms-race
#| fig-cap: "Cumulative payoffs over 50 rounds of an arms race (iterated PD) under four strategy matchups. Tit-for-Tat sustains cooperation, while Always Defect locks both sides into low payoffs."
#| fig-width: 7
#| fig-height: 5
...
```{r}
#| label: cuban-missile-equilibria
...
- **Repeated interaction** transforms one-shot Chicken into a folk-theorem setting where cooperation can be sustained (@sec-repeated-games).
