...
author: "Raban Heller"
date-modified: today
abstract: "Game-theoretic analysis of auctions: first-price, second-price (Vickrey), English, and Dutch formats, revenue equivalence, optimal bidding strategies, and R simulations."
keywords: ["auctions", "revenue equivalence", "Vickrey", "first-price", "optimal bidding"]
other-links:
  - text: Download Chapter PDF
    href: ../downloads/auction-theory.pdf
    icon: file-pdf
---
...
#| fig-cap: "Expected revenue comparison across four auction formats with 5 bidders and 1000 simulated auctions. Revenue equivalence holds: all formats yield similar expected revenue."
#| fig-width: 7
#| fig-height: 5
...
```{r}
#| label: fig-bid-function
#| fig-cap: "Optimal bid as a function of valuation in a first-price sealed-bid auction. As the number of bidders increases, equilibrium bids approach valuations (the 45-degree line), reflecting increased competition."
#| fig-width: 6
#| fig-height: 5
...
- **Optimal auction design** (@sec-mechanism-design) uses Myerson's framework to design revenue-maximizing mechanisms, including reserve prices that screen out low-value bidders.
