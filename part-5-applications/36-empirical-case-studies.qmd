...
author: "Raban Heller"
date-modified: today
abstract: "Real-world applications of game theory analyzed with R — spectrum auctions, kidney exchange, and Braess's paradox in traffic routing."
keywords: ["case studies", "spectrum auction", "kidney exchange", "Braess paradox", "traffic routing", "Wardrop equilibrium"]
other-links:
  - text: Download Chapter PDF
    href: ../downloads/empirical-case-studies.pdf
    icon: file-pdf
---
...
#| fig-cap: "Kidney exchange compatibility network. Nodes represent incompatible patient-donor pairs (coloured by patient blood type). Edges show potential donations. Highlighted thick edges are matched pairwise exchanges."
#| fig-width: 7
#| fig-height: 6
...
#| fig-cap: "Total travel time in the 4-node network under three scenarios. Adding a shortcut road increases total travel time at the selfish (Wardrop) equilibrium compared to the original network — Braess's paradox. A social planner can do better by controlling route assignments."
#| fig-width: 6
#| fig-height: 4.5
...
- **Mechanism design** (@sec-mechanism-design) provides the theoretical foundation for designing auctions and matching markets that achieve desired social outcomes.
