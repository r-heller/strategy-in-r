...
```{r, classic-2x2, fig.cap="Payoff structures of four classic 2x2 games. Each cell shows Player 1's payoff. The colour gradient highlights the incentive landscape: brighter cells are more attractive for the row player.", fig.width=8, fig.height=6}
...
```{r, iesds, tbl.cap="Payoff matrix for the 3x3 IESDS example. Each cell shows (Player 1, Player 2) payoffs. The IESDS solution (M, C) is highlighted."}
