...
```{r, matching-bipartite, fig.cap="Bipartite graph of the proposer-optimal stable matching for 6 hospitals and 6 residents. Left nodes are hospitals (proposers), right nodes are residents (receivers), and line segments connect matched pairs.", fig.width=6, fig.height=5}
...
```{r, proposer-advantage, fig.cap="Average rank of matched partner under proposer-optimal and receiver-optimal stable matchings across 200 random instances. Proposers obtain significantly better matches when they propose, confirming the structural advantage of the proposing side.", fig.width=6, fig.height=5}
