...
<img src="25-q-learning-in-games_files/figure-epub3/q-convergence-1.png" alt="Q-value evolution in a coordination game. Both agents converge to action A (the payoff-dominant Nash equilibrium), with Q-values stabilizing near the equilibrium payoff of 2." width="80%" />
<p class="caption">(\#fig:q-convergence)Q-value evolution in a coordination game. Both agents converge to action A (the payoff-dominant Nash equilibrium), with Q-values stabilizing near the equilibrium payoff of 2.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="25-q-learning-in-games_files/figure-epub3/q-cycling-1.png" alt="Q-value evolution in Matching Pennies (zero-sum). Instead of converging, Q-values oscillate as each agent's adaptation shifts the other's optimal play. The mixed NE at (0.5, 0.5) is never stably reached." width="80%" />
<p class="caption">(\#fig:q-cycling)Q-value evolution in Matching Pennies (zero-sum). Instead of converging, Q-values oscillate as each agent's adaptation shifts the other's optimal play. The mixed NE at (0.5, 0.5) is never stably reached.</p>
</div>
