...
<img src="18-spatial-pd_files/figure-epub3/spatial-snapshots-1.png" alt="Grid snapshots at generations 0, 5, 20, and 100. Cooperators (orange) form compact clusters that resist invasion by defectors (blue). By generation 20, the spatial pattern has largely stabilized into a dynamic equilibrium." width="80%" />
<p class="caption">(\#fig:spatial-snapshots)Grid snapshots at generations 0, 5, 20, and 100. Cooperators (orange) form compact clusters that resist invasion by defectors (blue). By generation 20, the spatial pattern has largely stabilized into a dynamic equilibrium.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="18-spatial-pd_files/figure-epub3/spatial-coop-fraction-1.png" alt="Cooperation fraction over 100 generations. After an initial transient where isolated cooperators are eliminated, the cooperation rate stabilizes around a dynamic equilibrium. Spatial structure sustains a substantial level of cooperation even in the one-shot Prisoner's Dilemma." width="80%" />
<p class="caption">(\#fig:spatial-coop-fraction)Cooperation fraction over 100 generations. After an initial transient where isolated cooperators are eliminated, the cooperation rate stabilizes around a dynamic equilibrium. Spatial structure sustains a substantial level of cooperation even in the one-shot Prisoner's Dilemma.</p>
</div>
