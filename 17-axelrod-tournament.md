...
<img src="17-axelrod-tournament_files/figure-epub3/axelrod-ranking-1.png" alt="Tournament ranking by total score. Tit for Tat wins the round-robin tournament, consistent with Axelrod's original finding. Nice strategies (those that never defect first) cluster at the top." width="80%" />
<p class="caption">(\#fig:axelrod-ranking)Tournament ranking by total score. Tit for Tat wins the round-robin tournament, consistent with Axelrod's original finding. Nice strategies (those that never defect first) cluster at the top.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="17-axelrod-tournament_files/figure-epub3/axelrod-heatmap-1.png" alt="Head-to-head scores in the round-robin tournament. Rows are the focal player; columns are the opponent. Always Defect scores highest against Always Cooperate but poorly against retaliatory strategies." width="80%" />
<p class="caption">(\#fig:axelrod-heatmap)Head-to-head scores in the round-robin tournament. Rows are the focal player; columns are the opponent. Always Defect scores highest against Always Cooperate but poorly against retaliatory strategies.</p>
</div>
