...
author: "Raban Heller"
date-modified: today
abstract: "Commitment devices, program equilibrium, and welfare gains from AI-to-AI cooperation mechanisms."
keywords: ["cooperative AI", "commitment", "program equilibrium", "Prisoner's Dilemma", "cooperation"]
other-links:
  - text: Download Chapter PDF
    href: ../downloads/cooperative-ai.pdf
    icon: file-pdf
---
...
```{r}
#| label: fig-cooperation-rates
#| fig-cap: "Cooperation rates (fraction of agents playing the cooperative action) under Nash equilibrium vs program equilibrium across three classic games. Commitment enables full cooperation in all games, including the Prisoner's Dilemma where Nash equilibrium yields zero cooperation."
#| fig-width: 7
#| fig-height: 5
...
```{r}
#| label: fig-welfare-pareto
#| fig-cap: "Welfare outcomes with and without commitment devices. Arrows show the movement from Nash equilibrium (circles) to program equilibrium (triangles) in payoff space. Commitment shifts outcomes toward the Pareto frontier in all three games."
#| fig-width: 7
#| fig-height: 5
...
- **AI safety applications.** Commitment devices can ensure that AI systems follow safety constraints. This connects to corrigibility (@sec-ai-alignment) and mechanism design (@sec-mechanism-design).
