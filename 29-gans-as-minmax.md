...
<img src="29-gans-as-minmax_files/figure-epub3/gan-evolution-1.png" alt="Evolution of the generator distribution during GAN training. The single Gaussian generator shifts and reshapes to approximate the bimodal target distribution. By epoch 300, the generator has moved toward one of the two target modes --- illustrating how a unimodal generator is fundamentally limited." width="80%" />
<p class="caption">(\#fig:gan-evolution)Evolution of the generator distribution during GAN training. The single Gaussian generator shifts and reshapes to approximate the bimodal target distribution. By epoch 300, the generator has moved toward one of the two target modes --- illustrating how a unimodal generator is fundamentally limited.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="29-gans-as-minmax_files/figure-epub3/gan-discriminator-1.png" alt="Discriminator accuracy on real and fake samples over training. As the generator improves, the discriminator's ability to identify fake samples decreases, approaching the Nash equilibrium prediction of 50% accuracy on both." width="80%" />
<p class="caption">(\#fig:gan-discriminator)Discriminator accuracy on real and fake samples over training. As the generator improves, the discriminator's ability to identify fake samples decreases, approaching the Nash equilibrium prediction of 50% accuracy on both.</p>
</div>
...
- **Evolutionary game theory connection**: GAN training can be viewed through the lens of replicator dynamics (\@ref(sec-replicator)), where the generator and discriminator populations co-evolve.
- **Minimax theorem**: The GAN objective satisfies the conditions of von Neumann's minimax theorem (\@ref(sec-minimax)) when the strategy spaces are convex and the payoff function is bilinear.
- **Multi-agent RL** (\@ref(sec-multi-agent-rl)) covers alternative adversarial training paradigms.
