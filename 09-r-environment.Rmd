...
```{r, benchmark-vectorized, fig.cap="Computation time for building an n-by-n payoff matrix using a nested loop versus vectorized outer product. Vectorized operations maintain near-constant time across matrix sizes, while loop-based computation scales quadratically. Error bars show plus or minus one standard deviation over five replications.", fig.width=7, fig.height=4.5}
...
```{r, save-benchmark-fig, include=FALSE}
