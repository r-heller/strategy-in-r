...
<img src="30-llm-agents-and-strategy_files/figure-epub3/levelk-distributions-1.png" alt="Predicted choice distributions in a 2/3-beauty contest for different levels of reasoning. Level-0 players choose near 50 (uniform random anchor). Each subsequent level best-responds to the level below, producing geometrically decreasing choices that converge toward the Nash equilibrium of 0." width="80%" />
<p class="caption">(\#fig:levelk-distributions)Predicted choice distributions in a 2/3-beauty contest for different levels of reasoning. Level-0 players choose near 50 (uniform random anchor). Each subsequent level best-responds to the level below, producing geometrically decreasing choices that converge toward the Nash equilibrium of 0.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30-llm-agents-and-strategy_files/figure-epub3/strategy-performance-1.png" alt="Win rates by strategy type in simulated beauty contest games. Level-1 and level-2 players outperform level-0 (random) players, but higher levels show diminishing returns because the population contains mostly low-level reasoners. The Nash equilibrium strategy (choose 0) rarely wins against bounded rational opponents." width="80%" />
<p class="caption">(\#fig:strategy-performance)Win rates by strategy type in simulated beauty contest games. Level-1 and level-2 players outperform level-0 (random) players, but higher levels show diminishing returns because the population contains mostly low-level reasoners. The Nash equilibrium strategy (choose 0) rarely wins against bounded rational opponents.</p>
</div>
...
- **Q-learning** (\@ref(sec-q-learning)) and **multi-agent RL** (\@ref(sec-multi-agent-rl)) offer alternative approaches to AI game-playing that learn through experience rather than language understanding.
