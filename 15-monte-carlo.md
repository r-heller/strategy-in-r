...
<img src="15-monte-carlo_files/figure-epub3/mc-convergence-1.png" alt="Convergence of the Monte Carlo payoff estimate to the analytical solution (dashed line at zero) for Matching Pennies under Nash equilibrium play. The shaded ribbon shows the 95% confidence interval, which narrows at rate $O(1/\sqrt{n})$." width="80%" />
<p class="caption">(\#fig:mc-convergence)Convergence of the Monte Carlo payoff estimate to the analytical solution (dashed line at zero) for Matching Pennies under Nash equilibrium play. The shaded ribbon shows the 95% confidence interval, which narrows at rate $O(1/\sqrt{n})$.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="15-monte-carlo_files/figure-epub3/mc-payoff-distribution-1.png" alt="Distribution of row-player payoffs under mixed-strategy Nash equilibrium play in Battle of the Sexes. The vertical dashed line marks the analytical expected payoff. The distribution is discrete with three mass points corresponding to the three distinct payoff values." width="80%" />
<p class="caption">(\#fig:mc-payoff-distribution)Distribution of row-player payoffs under mixed-strategy Nash equilibrium play in Battle of the Sexes. The vertical dashed line marks the analytical expected payoff. The distribution is discrete with three mass points corresponding to the three distinct payoff values.</p>
</div>
...
```{=html}
<div id="wavpxhopgw" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#wavpxhopgw table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#wavpxhopgw thead, #wavpxhopgw tbody, #wavpxhopgw tfoot, #wavpxhopgw tr, #wavpxhopgw td, #wavpxhopgw th {
  border-style: none;
}
...
#wavpxhopgw .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#wavpxhopgw .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#wavpxhopgw .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#wavpxhopgw .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#wavpxhopgw .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#wavpxhopgw .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#wavpxhopgw .gt_spanner_row {
  border-bottom-style: hidden;
}

#wavpxhopgw .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wavpxhopgw .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#wavpxhopgw .gt_from_md > :first-child {
  margin-top: 0;
}

#wavpxhopgw .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#wavpxhopgw .gt_row_group_first td {
  border-top-width: 2px;
}

#wavpxhopgw .gt_row_group_first th {
  border-top-width: 2px;
}

#wavpxhopgw .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#wavpxhopgw .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#wavpxhopgw .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#wavpxhopgw .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wavpxhopgw .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#wavpxhopgw .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wavpxhopgw .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wavpxhopgw .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#wavpxhopgw .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#wavpxhopgw .gt_font_normal {
  font-weight: normal;
}

#wavpxhopgw .gt_font_bold {
  font-weight: bold;
}

#wavpxhopgw .gt_font_italic {
  font-style: italic;
}
...
#wavpxhopgw .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#wavpxhopgw .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#wavpxhopgw .gt_indent_1 {
  text-indent: 5px;
}

#wavpxhopgw .gt_indent_2 {
  text-indent: 10px;
}

#wavpxhopgw .gt_indent_3 {
  text-indent: 15px;
}

#wavpxhopgw .gt_indent_4 {
  text-indent: 20px;
}

#wavpxhopgw .gt_indent_5 {
  text-indent: 25px;
}

#wavpxhopgw .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#wavpxhopgw div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
  <thead>
    <tr class="gt_heading">
      <td colspan="4" class="gt_heading gt_title gt_font_normal" style>Convergence of Monte Carlo Estimate</td>
    </tr>
    <tr class="gt_heading">
      <td colspan="4" class="gt_heading gt_subtitle gt_font_normal gt_bottom_border" style>Simplified poker game under estimated optimal play</td>
    </tr>
    <tr class="gt_col_headings">
      <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" scope="col" id="n">Samples</th>
      <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" scope="col" id="estimate">Estimate</th>
      <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" scope="col" id="se">Std Error</th>
      <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" scope="col" id="ci_width">95% CI Width</th>
    </tr>
  </thead>
  <tbody class="gt_table_body">
    <tr><td headers="n" class="gt_row gt_right">100</td>
<td headers="estimate" class="gt_row gt_right">0.450</td>
<td headers="se" class="gt_row gt_right">0.0869</td>
<td headers="ci_width" class="gt_row gt_right">0.3406</td></tr>
    <tr><td headers="n" class="gt_row gt_right">500</td>
<td headers="estimate" class="gt_row gt_right">0.476</td>
<td headers="se" class="gt_row gt_right">0.0377</td>
<td headers="ci_width" class="gt_row gt_right">0.1478</td></tr>
    <tr><td headers="n" class="gt_row gt_right">1000</td>
<td headers="estimate" class="gt_row gt_right">0.453</td>
<td headers="se" class="gt_row gt_right">0.0272</td>
<td headers="ci_width" class="gt_row gt_right">0.1065</td></tr>
    <tr><td headers="n" class="gt_row gt_right">5000</td>
<td headers="estimate" class="gt_row gt_right">0.396</td>
<td headers="se" class="gt_row gt_right">0.0123</td>
<td headers="ci_width" class="gt_row gt_right">0.0484</td></tr>
    <tr><td headers="n" class="gt_row gt_right">10000</td>
<td headers="estimate" class="gt_row gt_right">0.377</td>
<td headers="se" class="gt_row gt_right">0.0088</td>
<td headers="ci_width" class="gt_row gt_right">0.0344</td></tr>
    <tr><td headers="n" class="gt_row gt_right">20000</td>
<td headers="estimate" class="gt_row gt_right">0.375</td>
<td headers="se" class="gt_row gt_right">0.0062</td>
<td headers="ci_width" class="gt_row gt_right">0.0242</td></tr>
  </tbody>
