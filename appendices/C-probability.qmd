...
other-links:
  - text: Download Chapter PDF
    href: ../downloads/probability-essentials.pdf
    icon: file-pdf
---
...
**Bayes' theorem** is the foundation of Bayesian games (@sec-bayesian-games). It tells us how to update beliefs about a player's type after observing their action:
...
The **law of large numbers** guarantees that the sample mean converges to the true mean as the sample size grows. This justifies the Monte Carlo methods used extensively in @sec-monte-carlo.
