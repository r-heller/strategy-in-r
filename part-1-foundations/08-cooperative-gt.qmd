...
author: "Raban Heller"
date-modified: today
abstract: "An introduction to cooperative game theory with transferable utility. Covers the characteristic function, the core, and the Shapley value with computational examples in R, including a worked cost-sharing problem for three municipalities."
keywords: ["cooperative games", "Shapley value", "core", "coalition", "TU games", "characteristic function"]
other-links:
  - text: Download Chapter PDF
    href: ../downloads/cooperative-game-theory.pdf
    icon: file-pdf
---
